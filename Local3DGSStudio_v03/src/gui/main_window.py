...
# Pages implemented in phase01 + phase02 + phase03 + phase04. Anything
# else in the sidebar is shown as a "coming soon" placeholder so the
# full navigation is visible without pretending later phases already
# work.
_IMPLEMENTED_PAGES = {
    "Dashboard",
    "Projects Setup",
