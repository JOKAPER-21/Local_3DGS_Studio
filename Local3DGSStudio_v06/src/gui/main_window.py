...
# Pages implemented in phase01-05. Anything else in the sidebar is shown
# as a "coming soon" placeholder so the full navigation is visible
# without pretending later phases already work.
_IMPLEMENTED_PAGES = {
    "Dashboard",
    "Projects Setup",
    "Input",
...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self.reconstruction_qc_page = ReconstructionQCPage(self.project_manager)
        ...
        page_widgets = {
            ...
            "Reconstruction": self.reconstruction_qc_page,
            "Logs": self.logs_page,
    ...
    def _on_sidebar_row_changed(self, row: int) -> None:
        ...
        elif current_widget is self.colmap_page:
            self.colmap_page.refresh()
        elif current_widget is self.reconstruction_qc_page:
            self.reconstruction_qc_page.refresh()
